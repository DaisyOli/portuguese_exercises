...
Une plateforme propulsée par l'IA où des professeures de portugais créent des exercices interactifs, et où les élèves s'entraînent avec un retour instantané et personnalisé.

En bêta privée sur [app.practicebr.com](https://app.practicebr.com), testée par de vraies professeures et élèves. Conçue et déployée en solo — du premier commit à la mise en production sur Heroku — comme premier projet Rails après le bootcamp Le Wagon, et qui a largement dépassé ce point de départ depuis.
...
- Créez des activités en quelques minutes — ou laissez l'IA faire le gros du travail :
  - **Générez une activité complète à partir d'un prompt** (énoncé, explication et questions), propulsé par Claude — exécuté en tâche de fond avec un écran d'attente animé, pour que la professeure ne reste jamais bloquée sur une requête en cours
...
- Relisez les brouillons générés par l'IA avant publication — l'IA propose, la professeure dispose
- Invitez des élèves par email — chaque élève est rattaché à sa professeure
...
- Emails de rappel hebdomadaires (Resend + Heroku Scheduler) et suggestions quotidiennes de vidéos YouTube par professeure
...
- **Accès par rôle** (admin / professeure / élève / essai) appliqué au niveau des contrôleurs, chaque élève étant rattaché à la professeure qui l'a invité.
