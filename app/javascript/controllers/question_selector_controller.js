...
export default class extends Controller {
  // Definir os targets
  static targets = ["selector", "multipleChoice", "fillInBlank", "orderSentences", "correctAnswer"]
  ...
  hideAllFields() {
    ...
    if (this.hasOrderSentencesTarget) this.orderSentencesTarget.style.display = "none"
  ...
  showOrderSentencesFields() {
    if (this.hasOrderSentencesTarget) this.orderSentencesTarget.style.display = "block"
